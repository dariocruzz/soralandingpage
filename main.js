...
const T = {
  es: {
    ...
    "hero.sub":"Tu operación está perdiendo dinero. Cada pedido mal gestionado, cada error de stock y cada proceso manual es dinero que no vuelve. Construimos sistemas que automatizan pedidos, stock y atención para que puedas escalar sin caos operativo.",
    ...
    "cs.m1":"aumento en ventas en 45 días",
    "cs.m2":"errores operativos",
    "cs.m3":"semanales recuperadas",
    ...
    "s.contact":"Aplicá ahora", "ct.title":"Si tu operación hoy está frenando tu ecommerce, hablemos.", "ct.sub":"En una llamada de 30 minutos podemos detectar exactamente dónde estás perdiendo tiempo y dinero.",
    "ct.filter":"No trabajamos con ecommerce desde cero. Nos enfocamos en negocios que ya están vendiendo y necesitan ordenar su operación para escalar. Si tu sistema actual no te hace ganar más dinero cada mes, es el problema.",
  ...
  en: {
    ...
    "hero.sub":"Your operation is losing money. Every mismanaged order, stock error, and manual process is money that doesn't return. We build systems that automate orders, inventory, and support so you can scale without the chaos.",
    ...
    "cs.m1":"sales increase in 45 days",
    "cs.m2":"operational errors",
    "cs.m3":"weekly hours recovered",
    ...
    "s.contact":"Apply now", "ct.title":"If your op is holding your ecommerce back, let's talk.", "ct.sub":"In a 30 minute call we will precision-detect exactly where you are losing time and money.",
    "ct.filter":"We do not work with zero-revenue projects. We focus on businesses that are already selling and need to structure their logic to scale. If your current system doesn't make you more money every month, it's the problem.",
