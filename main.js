...
const T = {
  es: {
    ...
    "s.about":"Quiénes somos", 
    "ab.title":"La tecnología debería ser tu mayor activo, no un gasto invisible.",
    "ab.lead":"Si estás leyendo esto, sabés lo caro que es tener equipos estancados en flujos repetitivos o un ecosistema digital que tus clientes abandonan a la mitad.",
    "ab.desc1":"Durante más de 10 años hemos construido infraestructura digital que hoy opera de forma autónoma procesando ingresos reales. No somos un estudio abocado al premio de diseño. Somos <strong>arquitectos de software de alta conversión</strong>.",
    "ab.desc2":"Nuestra misión es simple: construir herramientas (apps, webs transaccionales, dashboards) que escalen por sí solas. Si tu tecnología no te ahorra tiempo ni te hace ganar más capital mes a mes, no sirve.",
    "ab.sig":"Equipo Director — Sora",
    "ab.s1":"+10 Años en mercado", "ab.s2":"100% Retorno Obsesivo",
  ...
  en: {
    ...
    "s.about":"Who we are", 
    "ab.title":"Technology should be your greatest asset, not an invisible expense.",
    "ab.lead":"If you are reading this, you know how expensive it is to have teams stuck in repetitive flows or a digital ecosystem that users abandon halfway.",
    "ab.desc1":"For over 10 years we have built digital infrastructure that operates autonomously, processing real revenue. We are not an award-chasing design studio. We are <strong>high-conversion software architects</strong>.",
    "ab.desc2":"Our mission is simple: build tools (apps, transactional webs, dashboards) that scale on their own. If your technology doesn't save you time or generate capital month to month, it's useless.",
    "ab.sig":"Directors Board — Sora",
    "ab.s1":"+10 Years in market", "ab.s2":"100% Obsessive ROI",
